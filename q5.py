def process_cuboid(a, b, c):
    ...
    #volume of a sphere formed from a cube of size `cube_size`
    pi = 355 / 113
    sphere_volume = (pi * cube_size ** 3) / 6
    
    #scrap for each cube is the difference between the cube's volume and the sphere's volume
    ...
    #now subtract the overlaps (to avoid double-counting):
